...
public class MainActivity extends AppCompatActivity implements PaymentStatusListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EasyUpiPayment easyUpiPayment = new EasyUpiPayment.Builder()
                .with(this)
                .setPayeeVpa("7385500660@axisbank")
                .setPayeeName("Ankur Pathak")
                .setTransactionId(UUID.randomUUID().toString().replaceAll("-",""))
                .setTransactionRefId(UUID.randomUUID().toString().replaceAll("-",""))
                .setDescription("Android APP Example")
                .setAmount("01.00")
                .build();
